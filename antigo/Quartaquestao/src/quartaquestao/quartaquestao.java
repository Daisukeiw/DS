 ...
 * @author pedro
 */
public class quartaquestao extends javax.swing.JFrame {

    /**
     * Creates new form quartaquestao
     */
    public quartaquestao() {
       initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/quartaquestao/clear.png"))); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(texto2, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(43, 43, 43)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(texto6)
                                    .addComponent(texto5, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        char txt = texto6.getText().charAt(1);
        char txt1 = texto5.getText().charAt(1);
        if(texto1.getText().equals("") || texto2.getText().equals("") || texto3.getText().equals("") ||
                texto4.getText().equals("") || txt == ' ' || txt1 == ' ' || conta.equals("")) {
            JOptionPane.showMessageDialog(null,"Algum campo está vazio");
        }else {
            String nome, endereco, cep, cod_agencia, num_conta, telefone;
            cod_agencia = texto1.getText();
            num_conta = texto2.getText();
            nome = texto3.getText();
            endereco = texto4.getText();
            telefone = texto5.getText();
            cep = texto6.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quartaquestao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new quartaquestao().setVisible(true);
            }
        });
    }
